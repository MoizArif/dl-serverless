...
def train(args):
    ...
    for index in range(3):
        shape.append(None if args[index + 2] == 'None' else int(args[index + 2]))
    print(args)
    ...
    #train_X, train_Y = train_ds["image"], train_ds["label"] # seperate the x and y
    ...
    if selected_model == 'vgg16':
        ...
        train_X = tensorflow.keras.applications.resnet.preprocess_input(train_X)
        ...
        train_X = tensorflow.keras.applications.mobilenet.preprocess_input(train_X)
        ...
        train_X = tensorflow.keras.applications.inception_v3.preprocess_input(train_X)
